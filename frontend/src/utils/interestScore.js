...
const CATEGORY_KW_MAP = {
  ...
  '금융':     ['주식','코인','환율','금리','채권','부동산투자','은행','보험','ETF'],
  ...
  '환경':     ['기후변화','탄소중립','재생에너지','원자력','태양광','풍력','미세먼지','생태계',
               '해양오염','플라스틱','탄소세','ESG','그린수소','폭염','홍수'],
  '국제':     ['미국','중국','일본','러시아','유럽','북한','중동','동남아','G7','NATO',
               'UN','무역분쟁','전쟁','외교','경제제재','인플레이션','공급망','반도체전쟁','AI패권','우크라이나',
               '대만','이스라엘','가자','인도'],
  '연예':     ['K-팝','영화','드라마','아이돌','웹툰','OTT','넷플릭스','음악','공연','뮤지컬','한류','게임','유튜브'],
  '스포츠':   ['축구','야구','농구','배구','테니스','골프','수영','육상','올림픽','월드컵',
               '손흥민','류현진','이강인','KBO','프리미어리그','UFC','e스포츠','메이저리그'],
}
